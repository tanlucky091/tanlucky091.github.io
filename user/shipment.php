                                        ...
                                        <table class="table text-dark text-center">
                                            ...
                                            while ($row = $result->fetch_assoc())
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <?php
                                                            if ($row["status_name"] == "Payment"){
                                                        ?>
                                                            <a href="shipment_payment/<?php echo $row["shipment_id"] ?>" class="btn btn-primary">Payment</a>
                                                        <?php
                                                        }
                                                            if (($row["parcel_num"] != "") && ($row["status_name"] == "Shipped")){
                                                        ?>
                                                            <a onclick="linkTrack(this.innerText)" class="btn btn-info"><?php echo $row["parcel_num"] ?></a>
                                                            <a href="shipment_received/<?php echo $row["shipment_id"] ?>" class="btn btn-primary">Received</a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </th>
